...
class Article(models.Model):
    ...
    title = models.CharField('Basliq', max_length = 150)
    descrtiption_block = tinymce_models.HTMLField('Məzmun blok', max_length = 5000, null=True, blank=True)

    descrtiption = tinymce_models.HTMLField('Məzmun', max_length = 10000)
    descrtiption2 = tinymce_models.HTMLField('Məzmun2', max_length = 10000, null=True, blank=True)
    descrtiption3 = tinymce_models.HTMLField('Məzmun3', max_length = 10000, null=True, blank=True)
    descrtiption4 = tinymce_models.HTMLField('Məzmun4', max_length = 10000, null=True, blank=True)
    descrtiption5 = tinymce_models.HTMLField('Məzmun5', max_length = 10000, null=True, blank=True)
    descrtiption6 = tinymce_models.HTMLField('Məzmun6', max_length = 10000, null=True, blank=True)
